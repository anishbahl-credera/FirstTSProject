...
import './FRH.css';
import Image from './frnksredhot.png'
...
export default function CholulaConfig() {
  ...
  useEffect(() => {
    document.body.classList.add('bodyFranksRedHot');
    return () => {
      document.body.classList.remove('bodyFranksRedHot');
    };
  }, []);
...
return (
  <center>
    <div className="bodyFranksRedHot">
