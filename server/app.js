...
app.get('/', (req, res) => {
    const responseData = {
      data: [
        ...
        { name: "Louisiana Hot Sauce", price: 2.89, description: "The perfect everyday hot sauce that will complement any meal. Made from aged hot peppers and vinegar, this sauce is anything but basic!" , origin: 'USA', ingredients: 'Aged Peppers, Distilled Vinegar, Salt', Scoville : 450, Size : 12, Image : "https://ibb.co/ncLJdXv"},
